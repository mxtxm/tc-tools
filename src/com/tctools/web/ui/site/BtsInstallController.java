...
public class BtsInstallController extends RouteToMethod {
    ...
    public void siteBtsInstallGet(Params params, HttpServletResponse response) throws AuthException {
    ...
    public void siteBtsInstallKeyval(Params params, HttpServletResponse response) throws AuthException {
        Services.get(ServiceAuth.class).permitAccess(params, Role.VENDOR, Role.ENGINEER, Role.MANAGER, Role.TECHNICIAN);
