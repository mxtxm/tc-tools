...
public class SectorOptimizationController extends RouteToMethod {
    ...
    public void siteSectorOptimizationGet(Params params, HttpServletResponse response) throws AuthException {
    ...
    public void siteSectorOptimizationKeyval(Params params, HttpServletResponse response) throws AuthException {
        Services.get(ServiceAuth.class).permitAccess(params, Role.VENDOR, Role.ENGINEER, Role.MANAGER, Role.TECHNICIAN);
