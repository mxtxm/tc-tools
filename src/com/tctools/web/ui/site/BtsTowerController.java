...
public class BtsTowerController extends RouteToMethod {
    ...
    public void siteBtsTowerGet(Params params, HttpServletResponse response) throws AuthException, ServiceException {
    ...
    public void siteBtsTowerKeyval(Params params, HttpServletResponse response) throws AuthException, ServiceException {
        Services.get(ServiceAuth.class).permitAccess(params, Role.VENDOR, Role.ENGINEER, Role.MANAGER, Role.TECHNICIAN);
