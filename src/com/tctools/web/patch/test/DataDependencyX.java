package com.tctools.web.patch.test;
...
public class DataDependencyX {

    private static final Logger log = LoggerFactory.getLogger(DataDependencyX.class);
    ...
    public DataDependencyX(Dto dto) {
        id = dto.getId();
    ...
    private void putAnnotatedDependencies(Field hostField, String prefix) {
        ...
        //todo: map<?,DTO> map<?,id> map<id,?>
        if (CollectionUtil.isMap(hostFieldType)) {
//            /*
//             * (9) field is Collection<Long> and items are fks to "target dto"
//             */
//            Class<?> gClassK = ClassUtil.getGenericTypes(hostField)[0];
//            Class<?> gClassV = ClassUtil.getGenericTypes(hostField)[1];
//            if (gClassV.equals(Long.class)) {
//                Dependants d = getDependantDataIn(hostFieldName);
//                if (d != null) {
//                    dependencies.add(d);
//                }
...
//
//            /*
//             * (10) field is Map<?,Dto> where
//             *     Dto-class="target dto".class and the objects are copies of some "target dto" records
//             */
//            if (gClassV.equals(dtoClass)) {
//                Dependants d = getDependantDataIn(hostFieldName + ".id");
//                if (d != null) {
//                    dependencies.add(d);
//                }
